...
var baseUrl = '/payment';
var vendorBundleSrc = '/payment/build/vendor.bundle.js?v=1.0.0.260';
var developerBundleSrc = '/payment/build/app.bundle.js?v=1.0.0.260';
var plansBundleSrc = '/payment/build/plans-1.0.0.260.bundle.js';
var appJsSrc = '/payment/scripts/app.js?v=1.0.0.260';
...
var mainCssSrc = '/payment/stylesheets/zty/main.css?v=1.0.0.260';
var resFileName = 'dev.json';
var portalJsFileName = 'dev.json';
var esShimSrc = 'scripts/es6/es6-shim.min.js';
var hkgrostekfont = 'styles/HKGrotesk/css/hkgrostekfont.css?v=1.0.0.260';
switch (hostParts[0]) {
case 'reg-builder':
    env = hostParts[0];
...
var ecomJsonPath = contentPath + blobFolder + 'zety.com/' + resFileName + '?v=1.0.0.260';
var localizedTextJsonPath = contentPath + blobFolder + 'zety.com/localizedText.json?v=1.0.0.260';
...
function loadImageFiles() {
    ...
    prefetchFiles('https://ssl.comodo.com/images/trusted-site-seal.png');
}
...
prefetchFiles('/payment/contents/' + blobFolder + 'common/localizedText.json?v=1.0.0.260');
